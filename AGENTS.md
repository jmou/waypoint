# Waypoint Documentation Guide

## Project Overview

- **README.md** - Quick start, architecture overview, and design decisions
...
- **e2e/README.md** - Test overview, running tests, test structure by phase
- **e2e/DATA_ATTRIBUTES.md** - Complete data attribute reference, code examples, common issues, Playwright patterns
